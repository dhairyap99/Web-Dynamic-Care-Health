...
<%!Connection con;
	...
	int row;
	String u,mail,subject,msg,df,dl,bid,dmail,dmsg,pf,pl,p,date,time,bdate,btime;
...
msg="Sorry to inform you that your appointment with Dr. "+df+" "+dl+", dated "+bdate+" at "+btime+" has been cancelled. (Booking ID: "+bid+")";
